...
const Register1 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    toast.success(
      `${email} руу имэйл илгээсэн холбоос дээр дарж бүртгэлээ баталгаажуулна уу`
    );
      ...
      <div className="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <h2 className="mt-1 text-center text-2xl font-extrabold text-gray-700">Бүртгүүлэх</h2>
            ...
            {/* <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-500">gmail-ээр нэвтрэх</span>
                </div>
              </div>
